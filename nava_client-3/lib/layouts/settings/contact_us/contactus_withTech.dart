...
class ContactUsTecn extends StatefulWidget {
  @override
  _ContactUsTecnState createState() => _ContactUsTecnState();
}

class _ContactUsTecnState extends State<ContactUsTecn> {
  ...
  //   }
  // }
//   Future<void> MessageTech() async {
//     // Showing CircularProgressIndicator using State.
//
//
//     // Getting value from Controller
//
//     String Message = tsupport.text;
//
//
//     // API URL
//     var phpurl = '';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      isLoading
                          ...
                          : CustomButton(
                        title: tr("send"),
                        onTap: () {if(tsupport.text.isEmpty)
                        {
                          Alert(context: context, title: tr("completeMessageTechnical")).show();
                          ...
                          // MessageTech();
                          ContactUs();
                          Alert(context: context, title: tr("hasBeenSent")).show();
                          tsupport.text='';}
                          // if(tsupport=="") {
