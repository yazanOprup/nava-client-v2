...
class MadaWebViewInvoice extends StatefulWidget {
  final int billNo;

  const MadaWebViewInvoice({Key key, this.billNo}) : super(key: key);

  @override
  _MadaWebViewInvoiceState createState() => _MadaWebViewInvoiceState();
}

class _MadaWebViewInvoiceState extends State<MadaWebViewInvoice> {
  ...
  Widget build(BuildContext context) {
    return WebviewScaffold(
      ...
      url:
      "https://navaservices.net/api/pay-invoice-mada?lang=ar&bill_id=${widget.billNo}",
    );
  }
}
